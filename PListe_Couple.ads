...
package PListe_Couple is
    ...
    type TListe_Couple is private;
        ...
        function nb_Suffixe(Tete: in TListe_Couple; Mot: in TMot) return Integer;
        	-- Renvoi le nombre de mot ayant mot1 pour suffixe
        	-- Renvoi 0 si il n'y en a pas

        function nb_Facteur(Tete: in TListe_Couple; Mot: in TMot) return Integer;
    ...
    private
        ...
        procedure ajout_Mot(Tete: in TListe_Couple; Mot: in TMot);
            -- Ajoute un nouveau couple contenant le mot si le mot n'est pas déjà présent, sinon augmente son occurrence de 1
        
        function tri_Decroissant_Occurrences(Tete: in TListe_Couple) return TListe_Couple;
